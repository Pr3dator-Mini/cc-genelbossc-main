...
print("")
print "\033[1;31mHola \033[0m" + real + "\033[1;35m encantado de conocerte Bienvenido :)\033[0m"
time.sleep(3)
print("")
...
def usage():
    ...
    print("\033[1;31m")
    print("+---------------+")
    print("+\033[;32m Editado por ElBossC\033[1;31m +")
    print("+---------------+\033[0m")
    print("")
    print("\033[1;33m Nickname: ElBossC\033[0m")
    print("\033[1;33m Youtube: No Hay\033[0m")
    print("\033[1;33m Telegram: t.me/ElBossC \033[0m")
    print("\033[1;33m Facebook: Nunca dejes de aprender compa")
    print("")
